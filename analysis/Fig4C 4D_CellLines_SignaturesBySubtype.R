...
pchs[!data$KrasMutStatus] <- 17

pdf("../figures/Fig4_CellLines_STK11signatureBySubtype.pdf", width=5.5, height=6.5)
...
pdf("../figures/Fig4_CellLines_MucinoussignatureBySubtype.pdf", width=5.5, height=6.5)
par(mar=c(4.5, 4.5, 3, 1))

...
load("../data/OAKmut_RNAseq_NMFGenes.RData")
...
pdf("../figures/FigS1_OAK_NMFcoefficients.pdf", width = 6, height = 5)
...
mtext(paste0("OAK - KRAS mutant (n=",nbTumors,")"), outer=TRUE, cex=1.5)
dev.off()

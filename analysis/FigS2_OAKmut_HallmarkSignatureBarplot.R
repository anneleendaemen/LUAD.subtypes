...
metadata <- read.table("../data/OAK_KRASmut_subtypes.tsv", sep="\t", header=TRUE, check.names=FALSE)
...
pdf("../figures/FigS2_OAKmut_HallmarkSignatureBarplots.pdf", width=6.5, height=7.5)
...
boxplot(scores ~ subtypes, horizontal=TRUE, col=colors, outline=FALSE,
				...
				xlab="Signature scores", yaxt="n", main="OAK - KRAS mutant")

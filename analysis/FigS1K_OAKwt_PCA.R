...
load("../data/OAKwt_RNAseq_ClassifierGenes.RData")
...
pdf("../figures/FigS1_OAKwt_SubtypePCA.pdf", width = 5.5, height = 6.5)
par(mar=c(4.5, 4.5, 3, 1))
plot(pca$x[,1], pca$x[,2], xlab="PC1", ylab="PC2", 
		main = paste0("OAK - KRAS wildtype (n=", ncol(eset), ")"),
		pch = 17, col = colors, 
...
pdf("../figures/FigS1_OAKwt_SubtypetSNE 10.pdf", width = 5.5, height = 6.5)
par(mar=c(4.5, 4.5, 3, 1))

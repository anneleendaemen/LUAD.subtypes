...
pdf("../figures/FigS5_OAK_SurvivalBySubtype_Atezolizumab.pdf", width=6, height=6, onefile=FALSE)
p
dev.off()
...
pdf("../figures/FigS5_OAK_PFSBySubtype_Atezolizumab.pdf", width=6, height=6, onefile=FALSE)
p
dev.off()

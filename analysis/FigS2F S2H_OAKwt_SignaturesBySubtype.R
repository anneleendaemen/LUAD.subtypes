...
pdf("../figures/FigS2_OAKwt_STK11signatureBySubtype.pdf", width=5.5, height=6.5)
...
pdf("../figures/FigS2_OAKwt_MucinoussignatureBySubtype.pdf", width=5.5, height=6.5)
par(mar=c(4.5, 4.5, 3, 1))

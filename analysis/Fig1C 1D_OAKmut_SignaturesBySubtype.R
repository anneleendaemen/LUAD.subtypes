...
pdf("../figures/Fig1_OAKmut_STK11signatureBySubtype.pdf", width=5.5, height=6.5)
...
pdf("../figures/Fig1_OAKmut_MucinoussignatureBySubtype.pdf", width=5.5, height=6.5)
par(mar=c(4.5, 4.5, 3, 1))

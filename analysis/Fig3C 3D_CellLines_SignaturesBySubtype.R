...
pdf("../figures/Fig3_CellLines_STK11signatureBySubtype.pdf", width=5.5, height=6.5)
...
pdf("../figures/Fig3_CellLines_MucinoussignatureBySubtype.pdf", width=5.5, height=6.5)
par(mar=c(4.5, 4.5, 3, 1))

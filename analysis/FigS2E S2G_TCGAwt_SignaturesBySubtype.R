...
pchs <- rep(17, nbTumors)

pdf("../figures/FigS2_TCGAwt_STK11signatureBySubtype.pdf", width=5.5, height=6.5)
...
pdf("../figures/FigS2_TCGAwt_MucinoussignatureBySubtype.pdf", width=5.5, height=6.5)
par(mar=c(4.5, 4.5, 3, 1))

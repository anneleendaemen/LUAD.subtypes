...
load("../data/OAKmut_RNAseq_ClassifierGenes.RData")
...
pdf("../figures/FigS1_OAKmut_SubtypePCA.pdf", width = 5.5, height = 6.5)
par(mar=c(4.5, 4.5, 3, 1))
plot(pca$x[,1], pca$x[,2], xlab="PC1", ylab="PC2", 
		main = paste0("OAK - KRAS mutant (n=", ncol(eset), ")"),
		pch = 19, col = colors, 
...
pdf("../figures/FigS1_OAKmut_SubtypetSNE 10.pdf", width = 5.5, height = 6.5)
par(mar=c(4.5, 4.5, 3, 1))
